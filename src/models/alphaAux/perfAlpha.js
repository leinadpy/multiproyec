...
perfilesAlpha.dosHojasBatientesPerf = async (newAbAlpha) => {
  ...
  // Hoja
  codigo = "AK109";
  medida = (newAbAlpha.ancho - 44) / 2 / 1000;
  corte = "45/45";
  cantidad = 4;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Contravidrio
  codigo = "AK130";
  medida = ((newAbAlpha.ancho - 44) / 2 - 84) / 1000;
  corte = "90/90";
  cantidad = 4;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  codigo = "AK108";
  medida = (newAbAlpha.alto - 104) / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ALTO";
  perfil = await calcPerfil(
...
perfilesAlpha.dosHojasOscilobatientesPerf = async (newAbAlpha) => {
  ...
  // Hoja
  codigo = "AK109";
  medida = (newAbAlpha.ancho - 46) / 2 / 1000;
  corte = "45/45";
  cantidad = 4;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Contravidrio
  codigo = "AK130";
  medida = ((newAbAlpha.ancho - 46) / 2 - 84) / 1000;
  corte = "90/90";
  cantidad = 4;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  medida = (newAbAlpha.ancho / 2 - oscilobat) / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Batiente central doble hoja
  codigo = "AK108";
  medida = (newAbAlpha.alto - 106) / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ALTO";
  perfil = await calcPerfil(
...
perfilesAlpha.unaPuertaHojaBatientePerf = async (newAbAlpha) => {
  ...
  codigo = "AK120";
  medida = (newAbAlpha.ancho - 230) / 1000;
  corte = "45/45";
  cantidad = 1;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  codigo = "AK110";
  medida = (newAbAlpha.ancho - 86) / 1000;
  corte = "45/45";
  cantidad = 1;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  codigo = "AK122";
  medida = (newAbAlpha.ancho - 155 + 20) / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Hoja
  codigo = "AK110";
  medida = (newAbAlpha.alto - 47 - 4) / 1000;
  corte = "45/45";
  cantidad = 2;
  lado = "ALTO";
  perfil = await calcPerfil(
  ...
  // Contravidrio
  codigo = "AK130";
  medida = (newAbAlpha.alto - 279) / 1000;
  corte = "90/90";
  cantidad = 2;
  lado = "ALTO";
  perfil = await calcPerfil(
...
perfilesAlpha.unaPuertaDosHojasBatientesPerf = async (newAbAlpha) => {
  ...
  // Zócalo inferior puerta batiente
  codigo = "AK120";
  medida = (newAbAlpha.ancho - 379) / 2 / 1000;
  corte = "45/45";
  cantidad = 2;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Hoja puerta apertura batiente
  codigo = "AK110";
  medida = (newAbAlpha.ancho - 91) / 2 / 1000;
  corte = "45/45";
  cantidad = 2;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Cortavientos inferior zócalo
  codigo = "AK122";
  medida = ((newAbAlpha.ancho - 229) / 2 + 20) / 1000;
  corte = "90/90";
  cantidad = 2;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Batiente central doble hoja
  codigo = "AK108";
  medida = (newAbAlpha.alto - 80 - 4) / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ALTO";
  perfil = await calcPerfil(
...
perfilesAlpha.unaHojaProyectantePerf = async (newAbAlpha) => {
  ...
  // Contravidrio
  codigo = "AK130";
  medida = (newAbAlpha.ancho - 138) / 1000;
  corte = "90/90";
  cantidad = 2;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Varilla de conexión
  codigo = "AK154";
  medida = (newAbAlpha.ancho - 128) / 2 / 1000;
  corte = "90/90";
  cantidad = 1;
  lado = "ANCHO";
  perfil = await calcPerfil(
  ...
  // Contravidrio
  codigo = "AK130";
  medida = (newAbAlpha.alto - 180) / 1000;
  corte = "90/90";
  cantidad = 2;
  lado = "ALTO";
  perfil = await calcPerfil(
